...
import { masterAdminCardTransactionColumn } from "../../common/components/custom-table/columns";
...
const CardTransactionList = () => {
  ...
  const column = masterAdminCardTransactionColumn(navigate,pagination,itemsPerPage);
    ...
    <div className="w-full flex flex-col gap-4 pr-5 pl-5">
      ...
      <div className="w-full h-20 flex flex-row items-center justify-between">
        <div className="flex flex-row items-center gap-4">
          ...
          />
          <button onClick={() =>handleSearch()} className="border border-purple-800">Search</button>
        </div>
