...
import { masterAdminFacilityServiceColumn } from "../../common/components/custom-table/columns";
...
const FacilityServiceList = () => {
  ...
  const column = masterAdminFacilityServiceColumn(navigate,pagination,itemsPerPage);
        ...
        <div className="flex flex-row items-center gap-8">
          ...
          <div className="h-12">
            <button
              ...
              onClick={() => navigate("createfacilityservice")}
            >
              New
            </button>
          </div>
